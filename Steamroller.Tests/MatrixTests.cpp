...
public:
	...
	TEST_METHOD(TestCreateFromCollection)
	{
		...
		const int collection[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
	...
	{
		const int matrix0Contents[] = { 3, 4, 2 };
		const sr::Matrix matrix0{ 3, 1, matrix0Contents };

		const int matrix1Contents[] = { 13, 9, 7, 15, 8, 7, 4, 6, 6, 4, 0, 3 };
	...
	{
		const int matrix0Contents[] = { 1, 2, 3, 4, 5, 6 };
		const sr::Matrix matrix0{ 3, 2, matrix0Contents };

		const int matrix1Contents[] = { 7, 8, 9, 10, 11, 12 };
